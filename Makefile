...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Oct 29 23:38:50 2012
...
SOURCES       = src/GLWidget.cpp \
		...
		src/AffineTransformer.cpp .moc/moc_GLWidget.cpp \
		.moc/moc_Window.cpp \
		.moc/moc_SideBar.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/MD2Viewer1.0.0/ && $(COPY_FILE) --parents src/TextureManager.h src/GLWidget.h src/Window.h src/SideBar.h src/pcx.h src/BMP.h src/md2.h src/MD2Wrapper.h src/MathVector.h src/AffineTransformer.h .obj/MD2Viewer1.0.0/ && $(COPY_FILE) --parents src/GLWidget.cpp src/main.cpp src/Window.cpp src/SideBar.cpp src/md2.cpp src/pcx.cpp src/MD2Wrapper.cpp src/MathVector.cpp src/TextureManager.cpp src/AffineTransformer.cpp .obj/MD2Viewer1.0.0/ && $(COPY_FILE) --parents src/SideBar.ui .obj/MD2Viewer1.0.0/ && (cd `dirname .obj/MD2Viewer1.0.0` && $(TAR) MD2Viewer1.0.0.tar MD2Viewer1.0.0 && $(COMPRESS) MD2Viewer1.0.0.tar) && $(MOVE) `dirname .obj/MD2Viewer1.0.0`/MD2Viewer1.0.0.tar.gz . && $(DEL_FILE) -r .obj/MD2Viewer1.0.0
...
compiler_moc_header_make_all: .moc/moc_GLWidget.cpp .moc/moc_Window.cpp .moc/moc_SideBar.cpp .moc/moc_AffineTransformer.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) .moc/moc_GLWidget.cpp .moc/moc_Window.cpp .moc/moc_SideBar.cpp .moc/moc_AffineTransformer.cpp
