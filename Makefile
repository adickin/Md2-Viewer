...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Oct 9 20:39:04 2012
...
SOURCES       = src/GLWidget.cpp \
		src/main.cpp \
		src/Window.cpp \
		src/SideBar.cpp .moc/moc_GLWidget.cpp \
		.moc/moc_Window.cpp \
		.moc/moc_SideBar.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/MD2Viewer1.0.0/ && $(COPY_FILE) --parents src/GLWidget.h src/Window.h src/SideBar.h .obj/MD2Viewer1.0.0/ && $(COPY_FILE) --parents src/GLWidget.cpp src/main.cpp src/Window.cpp src/SideBar.cpp .obj/MD2Viewer1.0.0/ && $(COPY_FILE) --parents src/SideBar.ui src/MainWindow.ui .obj/MD2Viewer1.0.0/ && (cd `dirname .obj/MD2Viewer1.0.0` && $(TAR) MD2Viewer1.0.0.tar MD2Viewer1.0.0 && $(COMPRESS) MD2Viewer1.0.0.tar) && $(MOVE) `dirname .obj/MD2Viewer1.0.0`/MD2Viewer1.0.0.tar.gz . && $(DEL_FILE) -r .obj/MD2Viewer1.0.0
